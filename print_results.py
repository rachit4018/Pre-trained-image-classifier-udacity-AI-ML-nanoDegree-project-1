...
def print_results(results_dic, results_stats_dic, model, 
    ...
    if (print_incorrect_dogs and 
        ...
        for key in results_dic:
            ...
            if (results_dic[key][3] == 0 and results_dic[key][4] !=0) or (results_dic[key][3] != 0 and results_dic[key][4] ==0):
                print("Pet Image label",results_dic[key][0])
                print("classifying label",results_dic[key][1])
